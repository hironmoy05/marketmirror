...
import {
  ...
  NameTextInput,
  RegEmailTextInput,
  RegPasswordTextInput,
  RegRetypePasswordTextInput,
  RegSponsorTextInput,
  FormButton,
  RegFormButton,
  LoginFormButton,
...
Login.RegPasswordTextInput = function LoginRegPasswordTextInput({
  ...restProps
}) {
  return <RegPasswordTextInput {...restProps} />;
};
Login.RegRetypePasswordTextInput = function LoginRegRetypePasswordTextInput({
  ...restProps
}) {
  return <RegRetypePasswordTextInput {...restProps} />;
};
Login.RegSponsorTextInput = function LoginRegSponsorTextInput({...restProps}) {
  return <RegSponsorTextInput {...restProps} />;
};
...
Login.FormButtonBox = function LoginScreenFormButtonBox({
  children,
  ...restProps
}) {
...
Login.RegisterTextBox = function LoginRegisterTextBox({
  children,
  ...restProps
}) {
  return (
