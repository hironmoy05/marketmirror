...
export const sentEmailStatus = state => state.entities.verifyEmail.sentEmailStatus;

export const sentEmailOtpStatus = state => state.entities.verifyEmail.sentOtpStatus;